...
Step 3. Go to your download folder and double click the arduino-ide.exe. Press the "continue", "next" and "install" buttons a few times. This will take a few minutes.
Step 4. Once it's done installing, choose the "run Arduino IDE" option and press "Finish".
Step 5a. You will now be asked to give some permissions, accept them to start using the IDE.
Step 5b. It might now to ask you to update to the newest version. If this is the case, follow the instructions
Step 6. After reopening choose the go to "select other board and port..." and choose the right Arduino model (Arduino UNO).
