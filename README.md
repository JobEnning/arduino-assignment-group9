...
Step 3. Go to your download folder and double-click the `arduino-ide.exe`. Press the "continue", "next" and "install" buttons a few times. Once it starts it will take a few minutes.
